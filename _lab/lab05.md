...
assigned: 2019-09-06 9:00:00.00-8
due: 2019-09-13 23:59:00.00-8
---
...
```
cd ~/cs24
git clone git@github.com:ucsb-cs24-mirza/lab05_jgaucho_alily.git
```
...
```
cp ~/cs24/cs24-starter-code/lab05/* ./
